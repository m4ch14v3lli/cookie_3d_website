    ...
    <>
      ...
      >
        <div className="absolute inset-0 rounded-2xl overflow-hidden border border-white/10 bg-[#0a0a0a]">
          <img src="/blueberry.avif" alt="Blueberry Muffin animation" className="w-full h-full object-cover" />
        ...
        >
          <div className="text-[#8c8273] uppercase tracking-widest text-[0.6rem] mb-2">No. 03</div>
          <h3 className="font-serif text-3xl text-[#e2d5c3] mb-4">Blueberry Muffin</h3>
          <p className="text-[#a1998c] text-sm leading-relaxed font-light backdrop-blur-md bg-black/40 p-4 rounded-lg border border-white/10 shadow-lg md:max-w-md">
            Infused with sweet, wild Maine blueberries and finished with a buttery muffin-style streusel crumb topping.
          </p>
        </div>
